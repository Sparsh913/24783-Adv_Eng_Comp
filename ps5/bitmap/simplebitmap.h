...
class SimpleBitmap : public SimpleBitmapTemplate <unsigned char,4> // inherit from SimpleBitmapTemplate
{
public:
	...
	*/
	...
	/*! Destructor can be empty since SimpleBitmapTemplate takes care of 
	    cleaning up. */
	~SimpleBitmap(){}
